...
@MultipartConfig
public class SearchShelter extends HttpServlet {
            ...
            try{
                ...
                Connection con=ConnectionProvider.getConnection();
                    ...
                    if(rs.next()){
                     ...
                     ShowShelter sd=new ShowShelter(state,city);
                    HttpSession hs=request.getSession();
                    hs.setAttribute("Sdata", sd);
                     response.sendRedirect("ShowShelter.jsp");
                }
                    else{
                      response.sendRedirect("Shelter.jsp");  
