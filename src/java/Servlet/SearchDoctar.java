 ...
 */
@MultipartConfig
public class SearchDoctar extends HttpServlet {
            ...
            try{
                ...
                Connection con=ConnectionProvider.getConnection();
                    ...
                    if(rs.next()){
                     ...
                     SearchDoctars sd=new SearchDoctars(state,city);
                    HttpSession hs=request.getSession();
                    hs.setAttribute("data1", sd);
                     response.sendRedirect("ShowDoctars.jsp");
                }
                    else{
