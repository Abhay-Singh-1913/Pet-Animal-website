                ...
                <div class="adop-2">
                    <div class="adop-3">
                        <%
                            ...
                            PreparedStatement ps = con.prepareStatement("select * from biopet where animaltype=?");
                            ps.setString(1, "dog");
                        ...
                        <div class="adop3" style="margin-left: 5rem;box-shadow: 10px 10px 15px rgba(0,0,0,0.3);">
                            <div class="#">
                                <div> <img style="width: 20rem;height: 15rem;" src="<%=ai%>"></div>

                                <div class="bookname"><span ><%=an%></span></div>
                                <div class="discription"><%=ad%></div>
                                <div class="Read-button">
                                    <button><a href="biopet2.jsp?animalname=<%=an%>">Read</a></button>
                ...
                <div class="adop-2">
                    <div class="adop-3">
                        <%
                            ...
                            PreparedStatement ps2 = con.prepareStatement("select * from biopet where animaltype=?");
                            ps.setString(1, "cat");
                            ...
                            while (rs2.next()) {
                                ...
                                String ad = rs2.getString("animalDiscription");
                                String av = rs2.getString("animalVideo");
                ...
                <div class="adop-2">
                    ...
                    <div class="adop-3">
                        <%
                            ...
                            PreparedStatement ps3 = con.prepareStatement("select * from biopet where animaltype=?");
                            ...
                            while (rs3.next()) {
                                ...
                                String ad = rs3.getString("animalDiscription");
                                String av = rs3.getString("animalVideo");
