...
<html>
    ...
    <body style="background-color: lightskyblue;">
        ...
        <div class="login-page" id="login-page">
            <div class="center">
                <h2>login</h2>
                <form method="post" action="LoginUS">
        ...
        <div class="login-page" id="patient-registration">
            ...
            <div class="center">
                ...
                <div class="Are-Doctor">
                    <a href="#" id="Doctor-page" >Shelter Registration?</a>
                </div>
                <form method="post" action="USRegistration">
                    <h2>
                        <input readonly name="UserShelter" value="USER">
                    </h2>
        ...
        <div class="login-page" id="Doctor-registration">
            ...
            <div class="center">
                <div class="Are-Doctor">
                    <a href="#" id="patient-page" >User Registration?</a>
                </div>
                <form method="post" action="USRegistration">
                    <h2><input readonly name="UserShelter" value="SHELTER"></h2>
                    ...
                    <div class="signup_link">
                        <a href="#" id="Login2">AlReady have an account?</a>
                    </div>
