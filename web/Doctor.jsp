...
<html>
    ...
    <body>
        ...
        <section>
            <form method="post" action="SearchDoctar">
                <div class="Dmid">

                    <img src="img/petDoctar2.webp"style="width:50rem;height: 35rem;">
                    <div class="Dmid1">
                        <h1 style="font-size: 3rem;font-weight: 2rem;">Welcome Your pet healths </h1>
                        <div class="Dmid2">

                            <span  style="font-size: 2rem;margin-left: 12rem;">Search and Find </span><br>
